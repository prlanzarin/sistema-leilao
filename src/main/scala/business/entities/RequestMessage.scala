...
case class AddAuctionRequest(p: Property, b: Date, e: Date)
    extends RequestMessage
case class AddBidRequest(uid : String, aid : Long, value : Double)
    extends RequestMessage
...
case class QueryPropertiesRequest(k: Option[String], i: Option[Boolean])
    extends RequestMessage
