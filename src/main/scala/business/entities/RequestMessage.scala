...
case class QueryOpenedAuctionsRequest(name: String, propertyKind: Option[String]) extends RequestMessage
case class QueryClosedAuctionsRequest(name: String, propertyKind: Option[String]) extends RequestMessage
...
case class QueryAuctionHistoryRequest(client: Client, propertyName: String, propertyKind: Option[String]) extends RequestMessage
